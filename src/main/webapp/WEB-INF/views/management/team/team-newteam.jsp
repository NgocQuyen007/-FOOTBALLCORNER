            ...
            <div class="layout-main">
                ...
                <div class="page-team-setting layout-main-content ng-scope">
                    <div class="heading-block">
                        <!-- ngIf: teamId == 0 --><p ng-if="teamId == 0" class="title-box ng-scope"><i class="fa fa-map-marker" aria-hidden="true"></i> Thêm đội bóng mới</p><!-- end ngIf: teamId == 0 -->
                        <!-- ngIf: teamId > 0 -->
                    </div> <!-- /.heading-block -->
                    <form class="form-horizontal ng-valid ng-dirty ng-valid-parse" role="form" style="">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9" style="padding-top:5px;">
                                <!-- ngIf: team.logoFilePath!=null && team.logoFilePath!='' -->
                                <input id="fileLogoFilePath" type="file" file-model="imageLogo">
                                <input ng-model="team.logoFilePath" value="" type="hidden" class="form-control ng-pristine ng-untouched ng-valid ng-empty" id="inpLogoFilePath" placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group age-range">
                            ...
                            <div class="col-md-9 row">
                                ...
                                <div class="col-sm-4 inlineBlock mobile-pull-right">
                                    <input ng-model="team.oldestAge" type="text" class="form-control ng-pristine ng-untouched ng-valid ng-empty" id="inpOldestAge" placeholder="Lớn tuổi nhất">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select-autocomplete-multi id="stadiumId" remote-url="/api/stadiums/autocomplete" multiple="false" filter-control-provinceid="#sltProvince" filter-control-countyid="#modalSltCounty" filter-control-teamid="#modalSltTeam" on-selected-change="TeamSettingsHelper.onSearchStadiumSelectedChange" item-id="sltStadium" item-placeholder="Nhập tên sân bóng......" class="ng-isolate-scope"><select style="width: 100%;" id="7edfc243-c8d2-4b1b-830c-060d6df3b74c" idd2="sltStadium" idd="sltStadium" class="select-autocomplete-directive select-autocomplete-multi form-control input-sm select2-hidden-accessible" tabindex="-1" aria-hidden="true"></select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-7edfc243-c8d2-4b1b-830c-060d6df3b74c-container"><span class="select2-selection__rendered" id="select2-7edfc243-c8d2-4b1b-830c-060d6df3b74c-container"><span class="select2-selection__placeholder">Nhập tên sân bóng......</span></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span></select-autocomplete-multi></div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3 inlineBlock">
                                    <label>Bắt đầu</label>
                                    <input type="text" class="form-control textbox-timepicker ng-pristine ng-untouched ng-valid ng-empty" ng-model="team.homeStartHour" placeholder="Bắt đầu">
                                </div>
                                <div class="col-sm-3 inlineBlock mobile-pull-right">
                                    <label>Kết thúc</label>
                                    <input type="text" class="form-control textbox-timepicker ng-pristine ng-untouched ng-valid ng-empty" ng-model="team.homeEndHour" placeholder="Kết thúc">
                                </div>
                            </div>
...
<a href="#top" class="back-to-top" style="display: block;"><i class="fa fa-angle-up" aria-hidden="true"></i></a>
