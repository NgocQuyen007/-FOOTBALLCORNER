...
<div class="content-wrap" ng-controller="matchFindingCtrl">
    <div class="container">
        <div class="row">
                        ...
                        <ul class="list-left-links list-left-check">
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li onclick="location.href='/tim-doi-da-bong?level=2';" >
                                        <div class="checkbox">
                                            <label>
                                                <input id="fsdso" name="fo" type="checkbox" value="true" /><input name="fo" type="hidden" value="false" /> Trung b&#236;nh
                                                <span class="pull-right filter-count">68</span>
                                            </label>
                                        </div>
                                    </li>
                                    <li onclick="location.href='/tim-doi-da-bong?level=3';" >
                                        <div class="checkbox">
                                            <label>
                                                <input id="2112fo" name="fo" type="checkbox" value="true" /><input name="fo" type="hidden" value="false" /> Trung b&#236;nh kh&#225;
                                                <span class="pull-right filter-count">17</span>
                                            </label>
                                        </div>
                                    </li>
                                    <li onclick="location.href='/tim-doi-da-bong?level=5';" >
                                        <div class="checkbox">
                                            <label>
                                                <input id="a2fo" name="fo" type="checkbox" value="true" /><input name="fo" type="hidden" value="false" /> Trung b&#236;nh yếu
                                                <span class="pull-right filter-count">208</span>
                                            </label>
                                        </div>
                                    </li>
                                </ul>
            ...
            <div class="col-md-6">
                <div class="p-content">
                    <h1 id="a" class="title-intent title-pages"><i class="fa fa-futbol-o" aria-hidden="true"></i>T&#236;m đối đ&#225; b&#243;ng</h1>
    ...
    <span class="dropdown-toggle" data-toggle="dropdown">
        <i class="fa fa-angle-down" aria-hidden="true"></i>
                        ...
                        <li class="item-card match-finding-item" idd="37514">
                            <div class="row">
                                <div class="col-md-12 right-item-san right-item-doi">
                                    ...
                                    <div class="header-item-doi header-tim-doi ">
                                        <div class="match-header-texts">
                                            <h2>
                                                ...
                                                <a href="/vach-ngan-viet-nam.html?matchId=37514" title="V&#225;ch Ngăn Việt Nam">V&#225;ch Ngăn Việt Nam<i class="fa fa-caret-right" aria-hidden="true"></i>S&#226;n b&#243;ng Mai V&#224;ng</a>
                                            </h2>
                                            <p class="captain-item noborder" owner-id="1536">
                                                <a href="/user/profile/1536"><i class="fa fa-user" aria-hidden="true"></i> Trần Vương Trần</a>
                                                <span class="captain-item-status offline hide"></span>
                                                <span class="chat-nhanh" ng-click="onQuickChat(1536);"><i class="fa fa-comments" aria-hidden="true"></i>Nói chuyện</span>
                                            </p>
                                        </div>
                                        <div class="btn-doi-top pull-right">
    ...
    <span class="dropdown-toggle" data-toggle="dropdown">
        <i class="fa fa-angle-down" aria-hidden="true"></i>
                                            ...
                                            <button class="btn btn-sm btn-default pull-right btn-batdoi modal-link-angularjs" data-modal-tpl="match.recipientMaker"
                                                    login-required="true" data-modal-qs="toTeamId=8764&toUserId=1536&toMatchId=37514&matchId=37514&teamId=8764&toTeamName=V&#225;ch Ngăn Việt Nam">
                                                <i class="fa fa-send" aria-hidden="true"></i> Bắt đối
                                            </button>
                                    ...
                                    <p class="tim-doi-time"><i class="fa fa-calendar-check-o" aria-hidden="true"></i><strong>Thời gian:</strong>17h00 Thứ Năm ngày 26/04/2018</p>

                                    <p class="item-stadium-p">
                                        <i class="fa fa-shirtsinbulk" aria-hidden="true"></i><strong>Sân nhà:</strong><a href="/san-bong-mai-vang.html" target="_blank">Sân bóng Mai Vàng</a>
                                    </p>
                                    <p class="item-stadium-address"><i class="fa fa-shirtsinbulk" aria-hidden="true"></i><strong>Địa chỉ:</strong>2/25B đường ĐHT 02, KP5, p. Tân Hưng Thuận (Quận 12 Hồ Chí Minh)</p>
                                    <p class="level-row">
                                        <i class="fa fa-shirtsinbulk" aria-hidden="true"></i><strong>Trình độ:</strong>Mới chơi, Trung b&#236;nh, Trung b&#236;nh kh&#225;, Trung b&#236;nh yếu, Kh&#225;
                                    </p>
                                    <p class="match-contract">
                                        <i class="fa fa-shirtsinbulk" aria-hidden="true"></i><strong>Kèo:</strong>
                                        Thỏa thuận
                                    ...
                                    <p class="quost-doi">
                                        Thử tài cùng team vách ngăn việt nam nào ^^ <br>Liên hệ 0906.657.659
                                    </p>
    ...
    <span class="dropdown-toggle" data-toggle="dropdown">
        <i class="fa fa-angle-down" aria-hidden="true"></i>
                    ...
                    <div class="col-md-12">
                        ...
                        </i></span><span class="noLinkPager hncurrpage">1</span>
                        <a href="/tim-doi-da-bong?pi=2" class="linkPager hnpagelink" title="2">
                        <span class="hnotherpage">2</span></a><a href="/tim-doi-da-bong?pi=3" class="linkPager hnpagelink" title="3">
                        <span class="hnotherpage">3</span></a><a href="/tim-doi-da-bong?pi=4" class="linkPager hnpagelink" title="4">
                        <span class="hnotherpage">4</span></a><a href="/tim-doi-da-bong?pi=5" class="linkPager hnpagelink" title="5">
                        <span class="hnotherpage">5</span></a><span class="noLinkPager dot">...</span><a href="/tim-doi-da-bong?pi=18" class="linkPager hnpagelink" title="18"><span class="hnotherpage">18</span>
                        </a><a href="/tim-doi-da-bong?pi=19" class="linkPager hnpagelink" title="19">
                        <span class="hnotherpage">19</span></a>
                        <a href="/tim-doi-da-bong?pi=2" class="linkPager hnpagenext" title="Trang sau">
                        	<span class="fix-pagination-padding hnotherpage"><i class="fa fa-angle-right" aria-hidden="true"></i>
                        	</span>
                        </a></div></div>
                    </div>
